defmodule AshAgentTools.IntegrationCase do
  @moduledoc """
  ...
  ## Usage
      ...
      defmodule AshAgentTools.Integration.ReqLLM.OpenAI.MetadataTest do
      ...
      defmodule AshAgentTools.Integration.Ollama.StreamingTest do
        use AshAgentTools.IntegrationCase, provider: :ollama
